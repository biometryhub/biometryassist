...
test_that("transformations are handled", {
    ...
    expect_equal(output.log2$low, c(0.22, 1.26, 1.94))
    expect_equal(output.log3$up, c(0.25, 1.41, 2.17))
    expect_equal(output.sqrt$predicted.value, c(0.49, 1.15, 1.42))
    expect_equal(output.sqrt2$low, c(0.23, 1.29, 1.98))
    expect_equal(output.sqrt3$up, c(0.27, 1.38, 2.09))
    ...
    expect_equal(output.inverse2$low, c(3.01, 1.66, 0.22))
    expect_equal(output.inverse3$up, c(1.20, 0.90, 0.20))
...
test_that("different interval types work", {
    ...
    expect_equal(output1$up, c(0.28, 1.36, 2.06))
    expect_equal(output2$low, c(0.19, 1.27, 1.97))
    expect_equal(output2$up, c(0.31, 1.39, 2.09))
...
test_that("lme4 model works", {
    ...
    expect_equal(output$std.error, rep(7.39, 4))
