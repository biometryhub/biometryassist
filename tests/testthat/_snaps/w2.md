...
# example 3 LMM works
    ...
    [0;34mResponse: Yield[0m
                ...
                Df denDF  F.inc        Pr
    (Intercept)  1     4 33.230 0.0044945
    Variety      3    12  6.187 0.0087474
...
# example 4 LMM works
    ...
    [0;34mResponse: DM[0m
                ...
                Df denDF   F.inc         Pr
    (Intercept)  1     3 3053.00 0.00001305
    trt          3     9   13.33 0.00116278
...
# example 5 works
    ...
    [0;34mResponse: Yield[0m
                       ...
                       Df denDF   F.inc      Pr
    (Intercept)         1     3 3029.00 0.00001
    Genotype           69   414    7.20 0.00000
    Fungicide           1     3   40.27 0.00791
    Genotype:Fungicide 69   414    0.93 0.62901
...
# example 6 works
    ...
    [0;34mResponse: Yield[0m
                ...
                Df denDF   F.inc        Pr
    (Intercept)  1   6.9 188.100 0.0000028
    Treatment   20  27.6   2.963 0.0043532
...
# example 7 works
    ...
    [0;34mResponse: Yield[0m
                   ...
                   Df denDF   F.inc      Pr
    (Intercept)     1   6.9 188.100 0.00000
    Control         1  30.1   3.400 0.07505
    Herbicide       7  27.5   3.415 0.00936
    Rate            2  29.6   0.038 0.96309
    Herbicide:Rate 10  29.4   3.180 0.00702

---

                             component  std.error  z.ratio bound %ch
    Block              0.0000002864157         NA       NA     B 0.0
    Column:Row!R       0.1790097741607 0.04842597 3.696565     P 0.0
    Column:Row!Row!cor 0.5407770686889 0.13654557 3.960414     U 0.1
...
# exercise 7 works
    ...
    [0;34m
    Wald tests for fixed effects.[0m
    [0;34mResponse: AverageFruitSize[0m
    
                Df denDF F.inc         Pr
    (Intercept)  1     4 65.47 0.00126796
    Variety      6    24 25.34 0.00000000
...
# exercise 8 works
    ...
    [0;34mResponse: Yield[0m
                ...
                Df denDF  F.inc      Pr
    (Intercept)  1     3 910.80 0.00008
    SeedingRate  5    15   1.32 0.30758

# exercise 9 works

    [0;34m
    Wald tests for fixed effects.[0m
    [0;34mResponse: EarInfect[0m
    
                Df denDF  F.inc           Pr
    (Intercept)  1    20 4333.0 0.0000000000
    Treatment    4    20   22.8 0.0000003259
...
# exercise 10 works
    ...
    [0;34m
    Wald tests for fixed effects.[0m
    [0;34mResponse: SugarYield[0m
    
                Df denDF   F.inc       Pr
    (Intercept)  1   0.7 124.100 0.115959
    Treatment    3  10.0   5.659 0.015736
...
# exercise 11 works
    ...
    [0;34mResponse: Yield[0m
                      ...
                      Df denDF   F.inc      Pr
    (Intercept)        1   5.0 245.100 0.00002
    Genotype           2  54.3   3.221 0.04766
    Nitrogen           3  43.2  27.050 0.00000
    Genotype:Nitrogen  6  50.1   0.223 0.96741
...
# exercise 12 works
    ...
    [0;34mResponse: Yield[0m
                       ...
                       Df denDF  F.inc       Pr
    (Intercept)         1     2 48.000 0.020205
    Variety             4    16  6.943 0.001937
    Irrigation          1     2 22.820 0.041135
    Variety:Irrigation  4    16  3.994 0.019644
...
# exercise 14 works
    ...
    [0;34mResponse: Yield[0m
                ...
                Df denDF   F.inc               Pr
    (Intercept)  1  17.7 23710.0 0.00000000000000
    Genotype    49  69.4     5.1 0.00000000047959
...
# exercise 15 works
    ...
    [0;34m
    Wald tests for fixed effects.[0m
    [0;34mResponse: loginf[0m
    
                Df denDF  F.inc       Pr
    (Intercept)  1   4.7 433.30 0.000008
    Control      1  15.2  17.60 0.000757
    Season       1  16.1   7.29 0.015705
    Rate         2  15.0   6.49 0.009355
    Season:Rate  2  20.8   1.35 0.280490
