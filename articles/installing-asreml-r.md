...
The developers of biometryassist do not provide support for `ASReml-R`
via way of bug reports or software patches, and any problems with the
ASReml-R software should be directed to [VSN
International](https://vsni.co.uk/). These installation instructions are
provided on a best-effort basis and any problems with the steps in this
...
function. This function will detect the appropriate version of R and
your operating system, and download the matching version of asreml. If
you’d rather not install the full package for this one function, you can
simply source the function from the public GitHub repository instead,
and run the function. See [Function Only Method](#function-only-method).

The `biometryassist` package is on CRAN, so can be installed using the
regular method:
...
This package will stay installed between R sessions, but will need to be
loaded with the library command any time you want to use the functions
within it.

## Function Only Method

To use only the function, without the additional overhead of the
...
To activate the licence code once asreml is installed, run the following
...
You will then be prompted to provide a licence code, which is a 16
...
The
[`install_asreml()`](https://biometryhub.github.io/biometryassist/reference/install_asreml.md)
function has a number of additional arguments, which you can read about
[on the documentation
site](https://biometryhub.github.io/biometryassist/reference/install_asreml.html).

If you already have ASReml-R installed, and want to update it or
reinstall it, you can use the
...
- For errors or problems encountered following these instructions, or
  problems using [functions in
  biometryassist](https://biometryhub.github.io/biometryassist/reference/index.html)
  with ASReml-R, contact the [developers of
  biometryassist](https://github.com/biometryhub/biometryassist/issues/new)
- For problems with licence activation, or for errors encountered using
  a successfully installed and licenced ASReml-R package, or for
  questions about how to use the ASReml-R package, [contact
  VSNi](https://vsni.co.uk/contact/).
